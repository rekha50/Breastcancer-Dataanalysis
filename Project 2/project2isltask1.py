...
#ROC curve for training data:
from sklearn.metrics import plot_roc_curve
roc_dlda = plot_roc_curve(clf2, x_train, y_train)
plt.show()


#ROC curve for testing data:
from sklearn.metrics import plot_roc_curve
roc_dlda = plot_roc_curve(clf2, x_test, y_test)
plt.show()
...
#ROC curve for training data:
from sklearn.metrics import plot_roc_curve
roc_qda = plot_roc_curve(qda, x_train, y_train)
plt.show()


#ROC curve for testing data:
from sklearn.metrics import plot_roc_curve
roc_qda = plot_roc_curve(qda, x_test, y_test)
plt.show()
...
#covariance of X under classes C1 and C2 are different, but the off-diagonal elements are 0 ie QDA
...
#ROC curve for training data:
from sklearn.metrics import plot_roc_curve
roc_dqda = plot_roc_curve(gnb, x_train, y_train)
plt.show()


#ROC curve for testing data:
from sklearn.metrics import plot_roc_curve
roc_dqda = plot_roc_curve(gnb, x_test, y_test)
plt.show()
